...
class SCadenceSubPalette : public SGraphPalette
{
public:
	SLATE_BEGIN_ARGS( SCadenceSubPalette )
		: _Title()
	 ...
	 * @param  InApplicationPtr	A pointer to the blueprint editor that this palette belongs to.
	 */
	void Construct(const FArguments& InArgs, TWeakPtr<FCadenceGraphApplication> InApplicationPtr);
	 ...
	 */
	UCadenceAsset* GetCadenceAsset() const;
